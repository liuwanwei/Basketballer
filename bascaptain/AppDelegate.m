...
- (void)initTabBar {
    ...
    NSInteger size = tabBarController.tabBar.items.count;
    for (NSInteger index = 0; index < size; index++) {
        UITabBarItem * item = [tabBarController.tabBar.items objectAtIndex:index];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[TeamManager defaultManager] loadTeams:YES];
